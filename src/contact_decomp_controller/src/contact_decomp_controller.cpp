...
ContactDecompController::command_interface_configuration() const {
...
controller_interface::InterfaceConfiguration
ContactDecompController::state_interface_configuration() const {
  controller_interface::InterfaceConfiguration config;
  config.type = controller_interface::interface_configuration_type::INDIVIDUAL;
...
CallbackReturn ContactDecompController::on_init() {
  params_listener_ = std::make_shared<contact_decomp_controller::ParamListener>(get_node());
  params_listener_->refresh_dynamic_parameters();
  params_ = params_listener_->get_params();
...
void ContactDecompController::setStiffnessAndDamping() {
  stiffness.setZero();
...
ContactDecompController::on_deactivate(const rclcpp_lifecycle::State & /*previous_state*/) {
  return CallbackReturn::SUCCESS;
}

void ContactDecompController::parse_target_pose_() {
...
void ContactDecompController::parse_target_joint_() {
...
void ContactDecompController::parse_target_wrench_() {
...
bool ContactDecompController::check_topic_publisher_count(const std::string & topic_name) {
...
PLUGINLIB_EXPORT_CLASS(
  crisp_controllers::ContactDecompController, controller_interface::ControllerInterface)