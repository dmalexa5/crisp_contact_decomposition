...
/**
 * @file contact_decomp_controller.hpp
 * @brief Hybrid controller implementation for robot manipulation (supports simultaneous position and force control)
 */
...
#include <contact_decomp_controller/contact_decomp_controller_parameters.hpp>
...
class ContactDecompController : public controller_interface::ControllerInterface {
public:
  /**
...
private:
  ...
  std::shared_ptr<contact_decomp_controller::ParamListener> params_listener_;
  /** @brief Current parameter values */
  contact_decomp_controller::Params params_;
