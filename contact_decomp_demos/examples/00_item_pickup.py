...
pickup_point = np.array([0.5, 0.0, 0.15])
ctrl_freq = 50.0
...
# to grip:
# ros2 action send_goal -f /franka_gripper/grasp franka_msgs/action/Grasp "{width: 0.00, speed: 0.05, force: 50, epsilon: {inner: 0.05, outer: 0.05}}"
# to stop:
...
robot.move_to(position=homing_pose.position, speed=0.15)
